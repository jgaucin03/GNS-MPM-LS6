...
flags.DEFINE_string("output_dir", None, help="Directory where output file should go")
...
class Render():
    ...
    def __init__(self, input_dir, input_name, output_dir):
        """
...
def main(_):
    ...
    if not FLAGS.output_dir:
        raise ValueError("A `output_dir` must be passed.")

    render = Render(input_dir=FLAGS.rollout_dir, input_name=FLAGS.rollout_name, output_dir=FLAGS.output_dir)
