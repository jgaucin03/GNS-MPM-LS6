...
# Jonathan Gaucin notes: Water does not have a friction angle or shear modulus or elastic modulus, it behaves like a fluid. Rho (Density) is 1000 kg/m^3

def run_collision(i, inputs, follow_taichi_coord, args):
